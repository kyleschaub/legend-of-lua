...
sprites.enemies = {}
sprites.enemies.eye = love.graphics.newImage('sprites/enemies/eye.png')
sprites.enemies.eyeShadow = love.graphics.newImage('sprites/enemies/eyeShadow.png')
sprites.enemies.eyeDead = love.graphics.newImage('sprites/enemies/eyeDead.png')
sprites.items = {}
