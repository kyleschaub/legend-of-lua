sprites = {}
sprites.playerSheet = love.graphics.newImage('sprites/player/playerSheet.png')
...
sprites.enemies.skeletonKnife = love.graphics.newImage('sprites/enemies/skeleton/knife.png')
